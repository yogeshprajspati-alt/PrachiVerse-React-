...
// Page Transitions - Absolute buttery crossfade
export const pageTransitionVariant = {
    initial: {
        opacity: 0,
        y: 15, // Barely any movement, just a breath 
        filter: 'blur(10px)',
    },
    animate: {
        opacity: 1,
        ...
        filter: 'blur(0px)',
        transition: {
            duration: 1.2, // Long duration for premium feel
            ease: customEasing
        }
    },
    exit: {
...
// Scroll Reveals - Slow, majestic rising fade
export const scrollRevealVariant = {
    hidden: {
        opacity: 0,
        y: 40,
        scale: 0.98, // Imperceptible scaling
        filter: 'blur(8px)'
    },
    visible: {
        opacity: 1,
...
// Stagger Items - Gently settling into place without any bounce
