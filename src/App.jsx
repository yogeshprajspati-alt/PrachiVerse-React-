      ...
      <Routes location={location} key={location.pathname}>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<MainLayout />}>
            ...
            <Route path="/JourneyBreak" element={<PageWrapper><JourneyBreak /></PageWrapper>} />
  ...
  return (
    <AuthProvider>
      <HashRouter>
        ...
        <Suspense fallback={
          <div style={{ width: '100%', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#0a0e27', color: '#8b5cf6' }}>
            <motion.div
